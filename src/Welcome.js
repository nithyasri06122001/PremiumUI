...
" width="270.11" height="649.9" overflow="visible">
  ...
  <div className='avatar'>
        <a href="https://atom.starhealth.in/login">
          <img src="https://play-lh.googleusercontent.com/aBHF38bONKHsIkqBp8oQJ0JDh71JZ3mG4mRRHZ_sr5TY8_d2sJejvWFqmBOqfUZJ3AY" alt="star health"></img>
        </a>
          </div>
    <div class="main__text-wrapper">
    <h1 class="main__title">STAR HEALTH INSURANCE</h1>
    <h2>Get Your Premium</h2>      
